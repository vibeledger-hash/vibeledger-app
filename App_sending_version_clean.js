/**
 * VibeLedger App - SENDING VERSION
 * Secure mobile payment system for sending money
 *
 * @format
 */
...
function App() {
  ...
  // Simple success animation for money sent
  ...
  const handleSendMoney = () => {
    console.log('Send Money button pressed');
    
    if (!recipientName.trim()) {
      setDemoMessage('Please enter recipient name');
      setTimeout(() => setDemoMessage(''), 3000);
      return;
    }
    ...
    setSuccessData({ amount: amount, recipient: recipientName });
    setRecipientName('');
    setAmount('');
  ...
  const renderOTPScreen = () => {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>Secure Mobile Payment System</Text>
  ...
  const renderTransactionHistoryScreen = () => {
    const transactions = [
      { id: 1, type: 'sent', amount: '25.00', person: 'John Doe', date: '2024-01-15' },
      { id: 2, type: 'sent', amount: '50.00', person: 'Jane Smith', date: '2024-01-14' },
      { id: 3, type: 'sent', amount: '12.50', person: 'Coffee Shop', date: '2024-01-13' }
    ];
        ...
        <View style={styles.transactionsList}>
          {transactions.map((transaction) => (
            <View key={transaction.id} style={styles.transactionItem}>
              ...
              <Text style={[styles.transactionType, styles.sentType]}>
                SENT
              </Text>
            </View>
          ))}
  ...
  const renderBLEPairingScreen = () => {
    const devices = [
      ...
      { id: 2, name: 'VibeLedger-Wallet-002', status: 'Connected', signal: '●●●●●' },
      { id: 3, name: 'VibeLedger-Phone-003', status: 'Available', signal: '●●○○○' }
    ];

    return (
      <View style={styles.container}>
        <Text style={styles.title}>BLE Device Pairing</Text>
        <Text style={styles.subtitle}>Connect nearby devices</Text>
