/**
 * VibeLedger Merchant App - RECEIVING VERSION
 * Secure mobile payment system for merchants to receive payments
 *
 * @format
 */
...
function App() {
  ...
  const handleReceivePayment = () => {
    ...
    if (!customerName.trim()) {
      setDemoMessage('Please enter customer name');
      setTimeout(() => setDemoMessage(''), 3000);
      return;
    }
    ...
    setSuccessData({ amount: amount, customer: customerName });
    setCustomerName('');
    setAmount('');
  ...
  const renderOTPScreen = () => {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.subtitle}>Secure Payment Receiving System</Text>
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.balanceContainer}>
          <Text style={styles.balanceLabel}>Daily Earnings</Text>
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.formContainer}>
          ...
          >
            <Text style={styles.receiveButtonText}>Request Payment</Text>
          </TouchableOpacity>
  ...
  const renderTransactionHistoryScreen = () => {
    const transactions = [
      { id: 1, type: 'received', amount: '25.00', customer: 'John Doe', date: '2024-01-15' },
      { id: 2, type: 'received', amount: '50.00', customer: 'Jane Smith', date: '2024-01-14' },
      { id: 3, type: 'received', amount: '12.50', customer: 'Coffee Customer', date: '2024-01-13' }
    ];
  ...
  const renderBLEPairingScreen = () => {
    const devices = [
      { id: 1, name: 'VibeLedger-POS-001', status: 'Available', signal: '●●●●○' },
      { id: 2, name: 'VibeLedger-Terminal-002', status: 'Connected', signal: '●●●●●' },
      { id: 3, name: 'VibeLedger-Reader-003', status: 'Available', signal: '●●○○○' }
    ];

    return (
      <View style={styles.container}>
        <Text style={styles.title}>POS Device Pairing</Text>
        <Text style={styles.subtitle}>Connect Payment Terminal</Text>
